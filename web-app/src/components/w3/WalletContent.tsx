...
import { WalletAddressIcon, CopyIcon, LightningIcon } from '@/lib/svgs';
...
const WalletContent = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center py-6">
            ...
            <button
                onClick={login}
                className="px-5 py-2.5 bg-gradient-to-br from-blue-900 to-blue-800 text-black font-medium rounded-lg
